package es.main.reverse.rasa.bot;
...
import es.main.reverse.rasa.bot.intents.Intent;
import es.main.reverse.rasa.bot.intents.Sentence;
		...
		for (Intent intent : this.intents) {
			for (Sentence sentence : intent.getSentences()) {
				if (sentence.hasParam()) {
					for (es.main.reverse.rasa.bot.intents.Entity param : sentence.getParams()) {
