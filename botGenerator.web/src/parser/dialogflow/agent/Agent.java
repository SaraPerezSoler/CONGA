package parser.dialogflow.agent;
...
import parser.dialogflow.agent.intents.Context;
import parser.dialogflow.agent.intents.Intent;
import parser.dialogflow.agent.intents.Message;
...
//					}
	...
	private HTTPResponse getDefaultResponse(HTTPRequest request) {
		...
		for (String lan : getLanguages()) {
			...
			for (TextLanguageInput lanInput : ret.getInputs()) {
