...
public class DialogflowGenerator {
  ...
  public void doGenerate(final Resource resource, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
    ...
    if (DialogflowGenerator.isPlugin) {
      String workspacePath = ResourcesPlugin.getWorkspace().getRoot().getLocation().toString();
      String _platformString = fsa.getURI(this.path).toPlatformString(true);
      String _plus_1 = ((workspacePath + "/") + _platformString);
      this.uri = _plus_1;
    } else {
      this.uri = ((DialogflowGenerator.newpath + "/") + this.path);
    }
    String _name_1 = bot.getName();
    CreateZip _createZip = new CreateZip(this.uri, _name_1);
    this.zip = _createZip;
    this.zip.addFile(this.uri, "package.json");
    ...
    this.zip.addFile(this.uri, "agent.json");
    ...
    for (final Entity entity : entities) {
      {
        ...
        String _plus_2 = ((this.path + "/entities/") + _name_2);
        String _plus_3 = (_plus_2 + ".json");
        fsa.generateFile(_plus_3, this.entityFile(entity));
        String _name_3 = entity.getName();
        String _plus_4 = (_name_3 + ".json");
        this.zip.addFileToFolder((this.uri + "/entities/"), "entities", _plus_4);
        ...
        for (final LanguageInput input : _inputs) {
          {
            ...
            String _plus_5 = ((this.path + "/entities/") + _name_4);
        ...
        String _name_4 = entity.getName();
        String _plus_5 = (_name_4 + "_entries_");
        String _languageAbbreviation = this.languageAbbreviation(lan);
        String _plus_6 = (_plus_5 + _languageAbbreviation);
        String _plus_7 = (_plus_6 + ".json");
        this.zip.addFileToFolder((this.uri + "/entities/"), "entities", _plus_7);
      }
    }
  ...
  public void createTransitionFiles(final UserInteraction transition, final String prefix, final IFileSystemAccess2 fsa, final Bot bot) {
    ...
    String _plus_3 = (_plus_2 + ".json");
    this.zip.addFileToFolder((this.uri + "/intents/"), "intents", _plus_3);
    ...
    for (final IntentLanguageInputs input : _inputs) {
      {
        ...
        String _plus_4 = (((this.path + "/intents/") + prefix) + _name_2);
        String _plus_5 = (_plus_4 + "_usersays_");
        String _languageAbbreviation = this.languageAbbreviation(lan);
        String _plus_6 = (_plus_5 + _languageAbbreviation);
        String _plus_7 = (_plus_6 + 
          ".json");
        fsa.generateFile(_plus_7, this.usersayFile(input));
        String _name_3 = transition.getIntent().getName();
        String _plus_8 = (prefix + _name_3);
        String _plus_9 = (_plus_8 + "_usersays_");
        String _languageAbbreviation_1 = this.languageAbbreviation(lan);
        String _plus_10 = (_plus_9 + _languageAbbreviation_1);
        String _plus_11 = (_plus_10 + ".json");
        this.zip.addFileToFolder((this.uri + "/intents/"), "intents", _plus_11);
      }
    }
