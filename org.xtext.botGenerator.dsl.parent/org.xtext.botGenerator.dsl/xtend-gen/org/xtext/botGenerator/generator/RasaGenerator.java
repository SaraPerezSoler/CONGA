...
public class RasaGenerator {
  ...
  public Object doGenerate(final Resource resource, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
      ...
      for(final Entity entity : entities) {
        {
          ...
          boolean _tripleEquals = (_entityType == BotGenerator.SIMPLE);
          if (_tripleEquals) {
            {
              EList<LanguageInput> _inputs = entity.getInputs();
              for(final LanguageInput simpleLanguage : _inputs) {
                {
                  boolean _equals = simpleLanguage.getLanguage().equals(lan);
                  if (_equals) {
                    String _rasaValue = this.getRasaValue(entity.getName());
                    _builder.append(_rasaValue);
                    _builder.append("_db={");
                    _builder.newLineIfNotEmpty();
                    {
                      EList<EntityInput> _inputs_1 = simpleLanguage.getInputs();
                      for(final EntityInput input : _inputs_1) {
                        _builder.append("\t");
                        _builder.append("\"");
                        String _lowerCase = ((SimpleInput) input).getName().toLowerCase();
                        _builder.append(_lowerCase, "\t");
                        _builder.append("\":[\"");
                        String _lowerCase_1 = ((SimpleInput) input).getName().toLowerCase();
                        ...
                        _builder.append("]");
                        {
                          boolean _isTheLast = DialogflowGenerator.isTheLast(entity.getInputs(), input);
                    ...
                    _builder.newLine();
                    _builder.append("def ");
                    String _rasaValue_1 = this.getRasaValue(entity.getName());
                    _builder.append(_rasaValue_1);
                    _builder.append("_validate(value:Text):");
                    _builder.newLineIfNotEmpty();
                    _builder.append("\t");
                    _builder.append("for input in ");
                    String _rasaValue_2 = this.getRasaValue(entity.getName());
                    _builder.append(_rasaValue_2, "\t");
                    _builder.append("_db:");
                    _builder.newLineIfNotEmpty();
                    _builder.append("\t\t");
                    _builder.append("if value.lower() in ");
                    String _rasaValue_3 = this.getRasaValue(entity.getName());
            ...
            boolean _tripleEquals_1 = (_entityType_1 == BotGenerator.COMPOSITE);
            if (_tripleEquals_1) {
              _builder.append("def ");
              String _rasaValue_4 = this.getRasaValue(entity.getName());
              ...
              for(final Parameter param_1 : _parameters_1) {
                ...
                _builder.newLineIfNotEmpty();
                {
                  ...
                  if (_tripleNotEquals) {
                    ...
                    boolean _tripleEquals_2 = (_defaultEntity == DefaultEntity.DATE);
                    if (_tripleEquals_2) {
                      _builder.append("\t\t");
                      ...
                      boolean _tripleEquals_3 = (_defaultEntity_1 == DefaultEntity.TIME);
                      if (_tripleEquals_3) {
                        _builder.append("\t\t");
                        ...
                        boolean _tripleEquals_4 = (_defaultEntity_2 == DefaultEntity.TEXT);
                        if (_tripleEquals_4) {
                          _builder.append("\t\t");
                          ...
                          boolean _tripleEquals_5 = (_defaultEntity_3 == DefaultEntity.FLOAT);
                          if (_tripleEquals_5) {
                            _builder.append("\t\t");
                            _builder.append("try:");
                            _builder.newLine();
                            ...
                            boolean _tripleEquals_6 = (_defaultEntity_4 == DefaultEntity.NUMBER);
                            if (_tripleEquals_6) {
                              _builder.append("\t\t");
                              _builder.append("try:");
                              _builder.newLine();
            ...
            _builder.newLine();
            {
              ...
              if (_not_5) {
                ...
                _builder.append("\t\t");
                {
                  ...
                  boolean _tripleEquals_7 = (_dataType == DataType.FORM);
                  if (_tripleEquals_7) {
  ...
  public CharSequence nlu(final List<Intent> intents, final List<Entity> entities, final Language lan) {
    StringConcatenation _builder = new StringConcatenation();
    {
      for(final Intent intent : intents) {
        {
          ...
          for(final IntentLanguageInputs intentLanguageInput : _inputs) {
            {
              ...
              if (_equals) {
                {
                  int _intentType = BotGenerator.intentType(intent);
                  boolean _tripleEquals = (_intentType == BotGenerator.TRAINING);
                  if (_tripleEquals) {
                    ...
                    _builder.newLineIfNotEmpty();
                    {
                      EList<IntentInput> _inputs_1 = intentLanguageInput.getInputs();
                      for(final IntentInput input : _inputs_1) {
                        _builder.append("- ");
                        String _generate = this.generate(((TrainingPhrase) input), lan);
    ...
    }
    {
      for(final Entity entity : entities) {
        _builder.newLine();
        {
          EList<LanguageInput> _inputs_2 = entity.getInputs();
          for(final LanguageInput languageInput : _inputs_2) {
            {
              boolean _equals_1 = languageInput.getLanguage().equals(lan);
              if (_equals_1) {
                {
                  int _entityType = BotGenerator.entityType(entity);
                  boolean _tripleEquals_1 = (_entityType == BotGenerator.SIMPLE);
                  if (_tripleEquals_1) {
                    {
                      EList<EntityInput> _inputs_3 = languageInput.getInputs();
                      for(final EntityInput input_1 : _inputs_3) {
                        _builder.append("## synonym:");
                        String _name = ((SimpleInput) input_1).getName();
                        _builder.append(_name);
                        _builder.newLineIfNotEmpty();
                        {
                          EList<String> _values = ((SimpleInput) input_1).getValues();
                    ...
                    int _entityType_1 = BotGenerator.entityType(entity);
                    boolean _tripleEquals_2 = (_entityType_1 == BotGenerator.REGEX);
                    if (_tripleEquals_2) {
                      ...
                      _builder.newLineIfNotEmpty();
                      {
                        EList<EntityInput> _inputs_4 = languageInput.getInputs();
                        for(final EntityInput input_2 : _inputs_4) {
                          _builder.append("- ");
                          String _expresion = ((RegexInput) input_2).getExpresion();
  ...
  public String generate(final TrainingPhrase phrase, final Language lan) {
    String ret = "";
  ...
  public String getEntry(final String string, final Entity entity, final Language lan) {
    EList<LanguageInput> _inputs = entity.getInputs();
    for (final LanguageInput languageInput : _inputs) {
      boolean _equals = languageInput.getLanguage().equals(lan);
      if (_equals) {
        EList<EntityInput> _inputs_1 = languageInput.getInputs();
        for (final EntityInput input : _inputs_1) {
          if ((input instanceof SimpleInput)) {
            boolean _equalsIgnoreCase = ((SimpleInput) input).getName().equalsIgnoreCase(string);
            if (_equalsIgnoreCase) {
              return ((SimpleInput) input).getName();
            }
            EList<String> _values = ((SimpleInput) input).getValues();
            for (final String synonym : _values) {
              boolean _equalsIgnoreCase_1 = synonym.equalsIgnoreCase(string);
  ...
  public CharSequence config(final Language lan) {
    ...
    _builder.newLine();
    {
      boolean _equals = lan.equals(Language.ENGLISH);
      if (_equals) {
        _builder.append("pipeline:");
        _builder.newLine();
        _builder.append("  ");
        _builder.append("- name: ConveRTTokenizer");
        _builder.newLine();
        _builder.append("  ");
        _builder.append("- name: ConveRTFeaturizer");
        _builder.newLine();
      } else {
        _builder.append("pipeline:");
        _builder.newLine();
        _builder.append("  ");
        _builder.append("- name: SpacyNLP");
        _builder.newLine();
        _builder.append("  ");
        _builder.append("- name: SpacyTokenizer");
        _builder.newLine();
        _builder.append("  ");
        _builder.append("- name: SpacyFeaturizer");
        _builder.newLine();
      }
    }
    _builder.append("  ");
    _builder.append("- name: RegexFeaturizer");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("- name: LexicalSyntacticFeaturizer");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("- name: CountVectorsFeaturizer");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("- name: CountVectorsFeaturizer");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("analyzer: \"char_wb\"");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("min_ngram: 1");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("max_ngram: 4");
    _builder.newLine();
    _builder.append("  ");
    ...
    _builder.newLine();
    _builder.append("  ");
    _builder.append("- name: EntitySynonymMapper");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("- name: ResponseSelector");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("epochs: 100");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("- name: \"DucklingHTTPExtractor\"");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("# url of the running duckling server");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("url: \"http://localhost:8000\"");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("# dimensions to extract");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("dimensions: [\"time\"]");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("# allows you to configure the locale, by default the language is");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("    ");
    _builder.append("# if not set the default timezone of Duckling is going to be used");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("# needed to calculate dates from relative expressions like \"tomorrow\"");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("timezone: \"Europe/Berlin\"");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("# Timeout for receiving response from http url of the running duckling server");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("# if not set the default timeout of duckling http url is set to 3 seconds.");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("timeout : 3");
    _builder.newLine();
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("  ");
    _builder.append("- name: \"FallbackPolicy\"");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("nlu_threshold: 0.3");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("ambiguity_threshold: 0.1");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("core_threshold: 0.3");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("fallback_action_name: \'action_default_fallback\'");
    _builder.newLine();
    return _builder;
  }
