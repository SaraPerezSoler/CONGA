...
public class BotParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, BotGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSimpleLanguageInputAccess().getGroup(), "rule__SimpleLanguageInput__Group__0");
			builder.put(grammarAccess.getSimpleLanguageInputAccess().getGroup_0(), "rule__SimpleLanguageInput__Group_0__0");
			builder.put(grammarAccess.getSimpleLanguageInputAccess().getGroup_2(), "rule__SimpleLanguageInput__Group_2__0");
			builder.put(grammarAccess.getCompositeAccess().getGroup(), "rule__Composite__Group__0");
			builder.put(grammarAccess.getCompositeLanguageInputAccess().getGroup(), "rule__CompositeLanguageInput__Group__0");
			builder.put(grammarAccess.getCompositeLanguageInputAccess().getGroup_1(), "rule__CompositeLanguageInput__Group_1__0");
			builder.put(grammarAccess.getCompositeLanguageInputAccess().getGroup_3(), "rule__CompositeLanguageInput__Group_3__0");
			...
			builder.put(grammarAccess.getIntentAccess().getParametersAssignment_4_1(), "rule__Intent__ParametersAssignment_4_1");
			builder.put(grammarAccess.getIntentAccess().getParametersAssignment_4_2(), "rule__Intent__ParametersAssignment_4_2");
			...
			builder.put(grammarAccess.getSimpleAccess().getInputsAssignment_5(), "rule__Simple__InputsAssignment_5");
			builder.put(grammarAccess.getSimpleLanguageInputAccess().getLanguageAssignment_0_2(), "rule__SimpleLanguageInput__LanguageAssignment_0_2");
			builder.put(grammarAccess.getSimpleLanguageInputAccess().getInputsAssignment_2_0(), "rule__SimpleLanguageInput__InputsAssignment_2_0");
			builder.put(grammarAccess.getSimpleLanguageInputAccess().getInputsAssignment_2_1(), "rule__SimpleLanguageInput__InputsAssignment_2_1");
			builder.put(grammarAccess.getCompositeAccess().getNameAssignment_3(), "rule__Composite__NameAssignment_3");
			builder.put(grammarAccess.getCompositeAccess().getInputsAssignment_5(), "rule__Composite__InputsAssignment_5");
			builder.put(grammarAccess.getCompositeLanguageInputAccess().getLanguageAssignment_1_2(), "rule__CompositeLanguageInput__LanguageAssignment_1_2");
			builder.put(grammarAccess.getCompositeLanguageInputAccess().getInputsAssignment_3_0(), "rule__CompositeLanguageInput__InputsAssignment_3_0");
			builder.put(grammarAccess.getCompositeLanguageInputAccess().getInputsAssignment_3_1(), "rule__CompositeLanguageInput__InputsAssignment_3_1");
