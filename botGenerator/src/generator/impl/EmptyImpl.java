 ...
 * </p>
 * <ul>
 *   <li>{@link generator.impl.EmptyImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EmptyImpl extends ActionImpl implements Empty {
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorPackage.EMPTY__DESCRIPTION, oldDescription, description));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GeneratorPackage.EMPTY__DESCRIPTION:
