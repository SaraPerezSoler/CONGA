...
public class EntityTokenImpl extends TokenImpl implements EntityToken, Comparable {
	...
	protected EClass eStaticClass() {
		return GeneratorPackage.Literals.ENTITY_TOKEN;
	}
		...
		if (entity != null && entity.eIsProxy()) {
			...
			if (entity != oldEntity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GeneratorPackage.ENTITY_TOKEN__ENTITY, oldEntity, entity));
			}
		}
		return entity;
	}
	...
	public void setEntity(Entity newEntity) {
		...
		entity = newEntity;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorPackage.ENTITY_TOKEN__ENTITY, oldEntity, entity));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GeneratorPackage.ENTITY_TOKEN__ENTITY:
