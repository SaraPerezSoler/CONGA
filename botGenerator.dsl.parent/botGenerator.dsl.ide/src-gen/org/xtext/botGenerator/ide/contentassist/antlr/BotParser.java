...
public class BotParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, BotGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTransitionAccess().getTargetAlternatives_3_1_0(), "rule__Transition__TargetAlternatives_3_1_0");
			builder.put(grammarAccess.getStateAccess().getAlternatives_3_1(), "rule__State__Alternatives_3_1");
			builder.put(grammarAccess.getState2Access().getAlternatives_4_1(), "rule__State2__Alternatives_4_1");
			...
			builder.put(grammarAccess.getStateAccess().getGroup_3_1_1(), "rule__State__Group_3_1_1__0");
			...
			builder.put(grammarAccess.getState2Access().getGroup_4_1_1(), "rule__State2__Group_4_1_1__0");
			...
			builder.put(grammarAccess.getButtonLanguageInputAccess().getGroup(), "rule__ButtonLanguageInput__Group__0");
			builder.put(grammarAccess.getButtonLanguageInputAccess().getGroup_0(), "rule__ButtonLanguageInput__Group_0__0");
			builder.put(grammarAccess.getButtonLanguageInputAccess().getGroup_0_1(), "rule__ButtonLanguageInput__Group_0_1__0");
			...
			builder.put(grammarAccess.getTransitionAccess().getNameAssignment_2_2(), "rule__Transition__NameAssignment_2_2");
			builder.put(grammarAccess.getTransitionAccess().getTargetAssignment_3_1(), "rule__Transition__TargetAssignment_3_1");
			...
			builder.put(grammarAccess.getStateAccess().getOutcomingAssignment_3_1_0(), "rule__State__OutcomingAssignment_3_1_0");
			builder.put(grammarAccess.getStateAccess().getBackToAssignment_3_1_1_1(), "rule__State__BackToAssignment_3_1_1_1");
			...
			builder.put(grammarAccess.getState2Access().getOutcomingAssignment_4_1_0(), "rule__State2__OutcomingAssignment_4_1_0");
			builder.put(grammarAccess.getState2Access().getBackToAssignment_4_1_1_2(), "rule__State2__BackToAssignment_4_1_1_2");
			...
			builder.put(grammarAccess.getButtonLanguageInputAccess().getLanguageAssignment_0_1_1(), "rule__ButtonLanguageInput__LanguageAssignment_0_1_1");
			builder.put(grammarAccess.getButtonLanguageInputAccess().getTextAssignment_3(), "rule__ButtonLanguageInput__TextAssignment_3");
			builder.put(grammarAccess.getButtonLanguageInputAccess().getButtonsAssignment_5(), "rule__ButtonLanguageInput__ButtonsAssignment_5");
