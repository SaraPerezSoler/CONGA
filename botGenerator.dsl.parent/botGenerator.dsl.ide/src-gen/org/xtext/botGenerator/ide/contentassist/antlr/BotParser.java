...
public class BotParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, BotGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getState2Access().getAlternatives_5_1(), "rule__State2__Alternatives_5_1");
			...
			builder.put(grammarAccess.getState2Access().getGroup_5(), "rule__State2__Group_5__0");
			builder.put(grammarAccess.getState2Access().getGroup_5_1_1(), "rule__State2__Group_5_1_1__0");
			...
			builder.put(grammarAccess.getState2Access().getOutcomingAssignment_5_1_0(), "rule__State2__OutcomingAssignment_5_1_0");
			builder.put(grammarAccess.getState2Access().getBackToAssignment_5_1_1_2(), "rule__State2__BackToAssignment_5_1_1_2");
