...
public class BotParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, BotGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getLanguageButtonAccess().getGroup_5(), "rule__LanguageButton__Group_5__0");
			...
			builder.put(grammarAccess.getLanguageButtonAccess().getInputsAssignment_4(), "rule__LanguageButton__InputsAssignment_4");
			builder.put(grammarAccess.getLanguageButtonAccess().getInputsAssignment_5_2(), "rule__LanguageButton__InputsAssignment_5_2");
			builder.put(grammarAccess.getLanguageButtonAccess().getButtonsAssignment_7(), "rule__LanguageButton__ButtonsAssignment_7");
